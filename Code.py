...
# Creating Widget
system = tk.Tk()
system.minsize(height=516,width=1150)
# Creating size of window
system.geometry('500x500')

# Background Colors
system.configure(background='grey')
...
# Creating title icon
# system.iconbitmap('C:/Users/akash/Downloads/Login-and-Registration-System-master/Login-and-Registration-System-master/img/Logo.ico')
''' Window Setting End '''

# Top Frame
top_frame = Label(system, text='HOTEL MANAGEMENT SYSTEM',font = ('Cosmic', 25, 'bold'), bg='#7268A6',relief='groove',padx=500, pady=30)
...
# Opening Image
image = ImageTk.PhotoImage(Image.open('C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/newbg6lf.jpg'))
