...
def Log():
    ...
    Login = tk.Tk()
    Login.minsize(height=516,width=1150)
    ...
    submit=tk.Button(frame,text = 'Login', command = goBack, width="10",bd = '3',  font = ('Times', 12, 'bold'), bg='#581845', fg='white',relief='groove', justify = 'center', pady='5') 
