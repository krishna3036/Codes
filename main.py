...
#cur.execute("insert into paymentsf values(1,'Shubhank','Khare','9589861196','Shubhank7673@gmail.com',2,'1','11','2023','11:20:27 PM','Cash','3500')")
...
# spath = "images/Central-Michigan-University.png"
# spath = Image.open('images/Central-Michigan-University.png')
image = Image.open(
	'C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/Central-Michigan-University.png')
spath1 = image.resize((500, 500))
simg = ImageTk.PhotoImage(spath1)
my = Label(sroot, image=simg)
my.image = simg
my.place(x=0, y=0)
Frame(sroot, height=516, width=5, bg='black').place(x=520, y=0)
# chilanka
Label(sroot, text="Hotel Management System ", font='Timesnewroman 35 ', bg='white', fg='black').place(x=535, y=10)
Label(sroot, text="Group 4 Project ", font='Timesnewroman 35 ', bg='white', fg='black').place(x=535, y=90)
Label(sroot, text="Akash Gupta", font='Timesnewroman 20 ', bg='white', fg='grey').place(x=535, y=180)
Label(sroot, text="Arun Thota", font='Timesnewroman 20 ', bg='white', fg='grey').place(x=535, y=220)
Label(sroot, text="Krishna Seknoor", font='Timesnewroman 20 ', bg='white', fg='grey').place(x=535, y=260)
Label(sroot, text="Madhuri Karjala", font='Timesnewroman 20 ', bg='white', fg='grey').place(x=535, y=300)
Label(sroot, text="Uday Kudithipudi", font='Timesnewroman 20 ', bg='white', fg='grey').place(x=535, y=340)
...
def mainroot():
	...
	path = "C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/newbg6lf.jpg"
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='group project 4',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		'''
		emp1f = Frame(b_frame)
		path1 = "C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/newman.jpg"
		...
		Label(emp1inf,text="Mr. Krishna ",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Contact : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : krishna@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		emp1inf.pack_propagate(False)
		emp1inf.place(x=117,y=1)

		emp1f = Frame(b_frame)
		path2 = "C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/receptionnew.jpg"
		...
		Label(emp1inf,text="Ms. Alysha",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Contact : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : alysha@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)	
		emp1inf.pack_propagate(False)
		emp1inf.place(x=767,y=2)

		emp1f = Frame(b_frame)
		path3 = "C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/fchefnew.jpg"
		...
		def menuf():
			root = Tk()
			root.title("Order")
			root.minsize(height=236,width=302)
			root.configure(bg='White')
			#global pmethod
			# cur.execute("Food Menu")
			# rp = cur.fetchone()
			# print (rp)
			# amtpd = str(int(rp[0])*int(nod.get()))
			Label(root,text='Food Menu ',font='msserif 14 bold',bg='White').place(x=0,y=0)
			Frame(root,height=2,width=300,bg='cyan4').place(x=0,y=39)
			Label(root,text='Indian Thali @ $15',bg='White',font='helvetica 15').place(x=0,y=43)
			Label(root,text='Cheese Pizza @ $10',bg='White',font='helvetica 15').place(x=0,y=80)
			Label(root,text='Chicken wings @ $10',bg='White',font='helvetica 15').place(x=0,y=115)
			Label(root,text='Salad Platter @ $6',bg='White',font='helvetica 15').place(x=0,y=150)
			
		pinv = Button(emp1inf,text='Food Menu',bg='Green',fg='white',command=menuf).place(x=220,y=5)
		#----------------------------------------
		Label(emp1inf,text="Mr. Rishi Jain (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Contact : 028",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : rishi@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)	
		emp1inf.pack_propagate(False)
		emp1inf.place(x=99,y=153)
		emp1inf.tkraise()

		emp1f = Frame(b_frame)
		path4 = "C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/roomservicenew.jpg"
		...
		def servicef():
			...
			# print (rp)
			# amtpd = str(int(rp[0])*int(nod.get()))
			Label(root,text='24X7 Services ',font='msserif 14 bold',bg='White').place(x=0,y=0)
			Frame(root,height=2,width=300,bg='cyan4').place(x=0,y=39)
			Label(root,text='Hotel Cleaning (2 times a day)',bg='White',font='helvetica 15').place(x=0,y=43)
			Label(root,text='Spa at room',bg='White',font='helvetica 15').place(x=0,y=80)
			Label(root,text='Laundry',bg='White',font='helvetica 15').place(x=0,y=115)
			Label(root,text='Luggage handling',bg='White',font='helvetica 15').place(x=0,y=150)
			
		pinf = Button(emp1inf,text='Services',bg='Green',fg='white',command=servicef).place(x=220,y=5)
		#----------------------------------------
		...
		Label(emp1inf,text="Mail : palak@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)	
		emp1inf.pack_propagate(False)
	...
	#cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar)")
				...
				if temp[0] == 'Reserved':
					...
					Radiobutton(payroot,text='Zelle     ',bg='White',variable=pmethod,value=3,font='helvetica 15',width=5).place(x=0,y=115+10)
					Radiobutton(payroot,text='Paypal ',bg='White',variable=pmethod,value=4,font='helvetica 15',width=5).place(x=0,y=150+10)
		...
		def unreserve():
			if (roomn.get() == 'Enter Room Number') or (roomn.get()==''):
				...
				con.commit()
		#--------------------------------------------------------right side---------------------------------------------------
		Label(b_frame,text='Room Availabilty',font='msserif 20',bg='gray93').place(x=750,y=0)
		...
		nl = Label(b_frame,text='group 4 project',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=955,y=310)
		nl.tkraise()
	#-------------login module----------------------------------------------------------------------------------------------------------------------
	def login():
	...
	path = "C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/rooms.png"
	img = ImageTk.PhotoImage(Image.open(path))
	b1 = Button(sl_frame,image=img,text='b1',bg='white',width=180,command=rooms)
	b1.image = img
	b1.place(x=180,y=0)
	path2 = "C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/hotelstatus.png"
	img1 = ImageTk.PhotoImage(Image.open(path2))
	b2 = Button(sl_frame,image=img1,text='b2',bg='white',width=180,command=hotel_status)
	b2.image = img1
	b2.place(x=0,y=0)
	path3='C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/guests.png'
	img3 = ImageTk.PhotoImage(Image.open(path3))
	b3 = Button(sl_frame,image=img3,text='b2',bg='white',width=180,command=staff)
	b3.image = img3
	b3.place(x=180*4,y=0)
	path4='C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/payments.png'
	img4 = ImageTk.PhotoImage(Image.open(path4))
	b4 = Button(sl_frame,image=img4,text='b2',bg='white',width=180,command = payments)
	b4.image = img4
	b4.place(x=180*3,y=0)
	path5='C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/logout.png'
	...
	path6='C:/Users/akash/Downloads/hotel-management-system-master/hotel-management-system-master/images/Bookroom.png'
	...
	Label(sl_frame,text='Room Service',font='msserif 13',bg='white').place(x=764,y=106)
