...
import time
Reg = tk.Tk()
Reg.minsize(height=516,width=1150)
...
# Creating register function
    ...
    # Creating title icon
    # Reg.iconbitmap('C:/Users/akash/Downloads/Login-and-Registration-System-master/Login-and-Registration-System-master/img/reglogo.ico')
    ...
    def database(arg=None):
        ...
        if condition:
            ...
            if password != confirm:
                ...
                cursor.execute("CREATE TABLE IF NOT EXISTS Users (FullName TEXT NOT NULL, Email TEXT NOT NULL, "
                               "Mobile TEXT NOT NULL, Username TEXT NOT NULL, Password TEXT NOT NULL)")
